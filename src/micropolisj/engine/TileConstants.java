...
public class TileConstants
{
	...
	static final char WIND_FARM = 967; //Tile id for the wind farm tiles. This is the id of the center of the tile as listed in tiles.rc
	public static final char LAST_TILE = 995;
